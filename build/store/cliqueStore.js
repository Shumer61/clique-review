...
import { createClique, joinClique, getUserCliques, getCliqueByInviteCode } from '../services/firestore';
export const useCliqueStore = create((set, get) => ({
    cliques: [],
    currentClique: null,
    loading: false,
    error: null,
    ...
    joinCliqueWithCode: async (inviteCode, userId) => {
        ...
        try {
            ...
            if (!clique.id)
                throw new Error('Clique ID missing');
